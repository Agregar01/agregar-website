            ...
            {isVideoOpen && (
                <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
                    <div className="relative w-full max-w-2xl">
                        ...
                        >
                            <source src="/public/video/Agregar Intro Video.mp4" type="video/mp4" />
                ...
                <div className=' grid grid-cols-1 lg:grid-cols-2 px-2 lg:px-52 relative z-10 gap-6 lg:gap-20'>
                    <div className=' space-y-5 animate__animated animate__backInLeft'>
                        ...
                        <div className=' space-y-6'>
                            ...
                            <div className=' flex items-center space-x-5'>
                                <button className=' border-2 border-secondary text-secondary font-semibold px-4 rounded-[6px] py-2 outfit'>Book a Demo</button>
                                <button className=' bg-primary text-white font-semibold px-8 py-2 rounded-[6px] border-2 border-primary outfit'>Learn More</button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div onClick={handleOpenVideo} className='relative cursor-pointer'>
                        ...
                        />
                            ...
                            <div className="  grid place-items-center absolute  transform -translate-x-1/2 -translate-y-1/2  h-20 w-20 rounded-full  cursor-pointer group">
                                <div>
                                    <Image alt='' src={play_logo} height={150} />
